  ...
  return (
    <div className="h-screen flex relative transition-colors duration-300 bg-black text-white">
      ...
      >
        ...
        <div
          className="relative grid grid-cols-6 grid-rows-7 md:grid-cols-8 md:grid-rows-5 lg:grid-rows-6 p-2"
          style={{
            gap: "10px",
            padding: "6px",
            width: "100%",
        ...
        >
                  ...
                  <span className="text-[8px] sm:text-[10px] md:text-[10px] lg:text-xs text-white/60 text-center break-words">
                    {userData?.socialLinks?.linkedInProfile
                      ? userData.socialLinks.linkedInProfile.includes("/in/")
                        ? userData.socialLinks.linkedInProfile.split("/in/")[1]
                        : userData.socialLinks.linkedInProfile
                      : "/in/jatinbuilds"}
                  </span>
                )}
          ...
          <div className="col-span-2 row-span-1 col-start-1 row-start-7 md:col-span-2 md:row-span-1  md:col-start-7 md:row-start-4 lg:row-span-2 lg:col-span-1 lg:row-start-5 z-10">
            <button
          ...
          <div className=" col-span-4 row-span-1 col-start-3 row-start-7 md:block md:col-span-2 md:row-span-1 md:col-start-7 md:row-start-5 lg:row-span-2 lg:col-span-1 lg:row-start-5 z-10">
            <button
